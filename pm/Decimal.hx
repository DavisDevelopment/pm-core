...
import pm.math.bigint.DecimalImpl;
import pm.math.bigint.Decimals;
import pm.math.bigint.Bigs;
import pm.math.bigint.Small;
...
abstract Decimal(DecimalImpl) from DecimalImpl to DecimalImpl {
  ...
  @:from 
  public static function fromInt(value : Int) : Decimal {
    return Decimals.fromInt(value);
  }

  @:from 
  inline public static function fromFloat(value : Float) : Decimal {
  ...
  public inline function greaterThan(that : Decimal):Bool return compareTo(that) > 0;

  @:op(A > B)
  static public inline function greater(self : Decimal, that : Decimal) : Bool {
