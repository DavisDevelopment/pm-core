...
class Std2 {
    public static inline var DIGITS = '0123456789abcdefghijklmnopqrstuvwxyz';
    ...
    static public inline function op_and(x:Int32, y:Int32):Int32 {
        return x & y;
    }

    static public inline function op_or(x:Int32, y:Int32):Int32 {
        return x | y;
    }

    static public inline function op_xor(x:Int32, y:Int32):Int32 {
        return x ^ y;
    }

    static public inline function op_andnot(x:Int32, y:Int32):Int32 {
        return x & ~y;
    }

    static public inline function sx8(v:Int32):Int32 {
        return (v << 24) >> 24;
    }

    static public inline function sx16(v:Int32):Int32 {
        return (v << 16) >> 16;
    }
...
class CType {
    ...
    static public inline function isDigit(charCode:Int32):Bool {
        return (charCode >= '0'.code && charCode <= '9'.code);
    }

    static public inline function isAlpha(charCode:Int32):Bool {
        return isUpperAlpha(charCode) || isLowerAlpha(charCode);
    }

    static public inline function isUpperAlpha(charCode:Int32):Bool {
        return ((charCode >= 'A'.code) && (charCode <= 'Z'.code));
    }

    static public inline function isLowerAlpha(charCode:Int32):Bool {
        return ((charCode >= 'a'.code) && (charCode <= 'z'.code));
    }
}
