...
abstract DateTimeUtc(Int64) {
     ...
     */
    @:from 
    public static function fromDate(date : Date):DateTimeUtc {
        #if cs // because of issue https://github.com/HaxeFoundation/haxe/issues/4452
     ...
     */
    @:from 
    public static function fromTime(timestamp : Float) : DateTimeUtc {
     ...
     **/
    public static function parse(s : String):Either<Dynamic, DateTimeUtc> {
        return try Either.Right(fromString(s)) catch (e : Dynamic) Left( e );
    }
