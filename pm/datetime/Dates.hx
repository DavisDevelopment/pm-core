/*
Ported into the `pm.*` framework/namespace from @fponticelli's [thx.core](http://github.com/fponticelli/thx.core)
@author Ryan Davis
@author Jason O'Neil
...
(Note to self) 
 ` -- RYAN!`
 `tempted as you may be, DO NOT add "inline" to every method in the damn module`
 `(that would increase code size, and eliminate most/all much-more-valuable JIT-optimization on targets like js or python+pypy3)`
...
class Dates {
	...
	**/
	...
	inline public static function more(self:Date, other:Date):Bool {return greater(self, other);}
	...
	**/
	...
	inline public static function moreEqual(self:Date, other:Date):Bool {return greaterEquals(self, other);}
	...
	**/
	...
	inline public static function lessEqual(self:Date, other:Date):Bool {return lessEquals(self, other);}
	...
	**/
	inline public static function daysInMonth(year:Int, month:Int) {
	...
	**/
	...
	public static function numDaysInThisMonth(d: Date) return daysInThisMonth(d);
