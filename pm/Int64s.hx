...
class Int64s {
  ...
  public static inline function abs(value : Int64): Int64
...
**/
  ...
  public static function divRound(num : Int64, div : Int64) : Int64 {
    if(num.isZero())
      return zero;
    if(div.isZero())
      return throw new Error('Int64s.divRound division by zero');
  ...
  public static function divFloor(num : Int64, div : Int64) : Int64 {
    if(num.isZero())
      return zero;
    if(div.isZero())
      return throw new Error('Int64s.divFloor division by zero');
  ...
  public static function divCeil(num : Int64, div : Int64) : Int64 {
    if(num.isZero())
      return zero;
    if(div.isZero())
      return throw new Error('Int64s.divCeil division by zero');
